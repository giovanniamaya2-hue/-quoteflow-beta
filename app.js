...
})();/* QUOTEFLOW - FINAL ENGLISH LANGUAGE FIX */
...
(function () {
  ...
  function applyEnglish() {
    ...
    const replacements = {
      ...
      "Cotiza más rápido. Protege tu ganancia.": "Estimate faster. Protect your profit.",

      "Un espacio sencillo para cotizaciones de contratistas.": "One simple quoting workspace for construction contractors.",
      ...
      "Asistente inteligente de alcance": "Smart Scope Assistant",

      "Registro diario": "Daily Job Log",
      ...
      "Salud de la cotización": "Quote Health",
      ...
      "Partidas del trabajo": "Work Items",
      ...
      "Notas / exclusiones": "Notes / Exclusions",

      "Firma del contratista": "Contractor Signature",

      "Aceptación / firma del cliente": "Customer Acceptance / Signature"
      ...
      nodes.forEach(function (textNode) {
        ...
        if (replacements[value]) {
          ...
          textNode.nodeValue =
            ...
            textNode.nodeValue.replace(value, replacements[value]);
    ...
    if (typeof window.renderDynamic === "function") {
  ...
  if (
    ...
    !originalSetLang.__qfEnglishFix
    ...
    window.setLang = function (language) {
      ...
      if (language === "en") {
        ...
        setTimeout(applyEnglish, 300);

        setTimeout(applyEnglish, 800);

      }

    };

    window.setLang.__qfEnglishFix = true;
